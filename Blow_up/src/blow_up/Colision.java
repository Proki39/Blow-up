...
public class Colision {
    ...
    public boolean Colision1(int speedX, int speedY, Block unBlock, Joueur unJoueur){
        ...
        unJoueur.getY()-9672+unJoueur.getLargeur()+speedY>=unBlock.getY() - 64 &&
        unJoueur.getX()+unJoueur.getHauteur()+speedX>=unBlock.getX() &&
        unJoueur.getX()+speedX<=unBlock.getX()+unBlock.getHauteur() &&
        unJoueur.getY()-9672+speedY<=unBlock.getY()+unBlock.getLargeur()){
            return true;}

        if(unBlock.getGenDown() &&                                            //Colision avec le block inferieur
        unJoueur.getY()-9672+unJoueur.getLargeur()+speedY>=unBlock.getY() &&
        unJoueur.getX()+unJoueur.getHauteur()+speedX>=unBlock.getX() &&
        unJoueur.getX()+speedX<=unBlock.getX()+unBlock.getHauteur() &&
        unJoueur.getY()-9672+speedY<=unBlock.getY()+unBlock.getLargeur() + 64){
            return true;}
        ...
        if(unJoueur.getY()-9672+unJoueur.getLargeur()+speedY>=unBlock.getY() &&     //Colision avec le centre du bloc
        unJoueur.getX()+unJoueur.getHauteur()+speedX>=unBlock.getX() &&
        unJoueur.getX()+speedX<=unBlock.getX()+unBlock.getHauteur() &&
        unJoueur.getY()-9672+speedY<=unBlock.getY()+unBlock.getLargeur()){
            return true;
